...
public class MainLoop : MonoBehaviour
{
    ...
    IEnumerator ThrowStones()
    {
        ...
        while (enableStones)
        {
            ...
            rb.AddTorque(Vector3.up * torque, ForceMode.Impulse); // y
            rb.AddTorque(Vector3.right * torque, ForceMode.Impulse); // x
            rb.AddTorque(Vector3.forward * torque, ForceMode.Impulse); // z
